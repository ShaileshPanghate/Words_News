...
const Home = () => {
    ...
    const content = {
        en: {
            ...
            Through 'Natural Origin Word Science', we supply refined phonetic words ('Shabdakoshavinashabd') via 'Shabdpathy'—an approach that provides language-based healing and knowledge transfer with the prior consent of the recipient.`,
            ...
            lastDetails: `A) That is why the global Saint Kabir Maharaj also, in Hindi, refers to "Adika," meaning from the primordial mute human to the primordial root human, describing how the original inhabitants expressed their words and how their life force (prana) existed.
            ...
            B) As a result of bringing these unnatural words into their mouths, what consequences followed?
            ...
            lastDetails2: `C) The Maharashtrian saint Avadhoot Maharaj (Vithoba Savanga) also followed the experiences and spiritual realizations of Saint Kabir Maharaj. Through his own self-experience, he orally conveyed in Marathi the natural root words of word science that he had received.
           ...
           J) To truly realize this vision, we must scientifically explore the origins of natural words through Shabdopathy (Word Therapy). This involves understanding and practicing words that have existed naturally along with their historical context, phonetic effects, and impact on human well-being.
            ...
            `,
            lastDetailsheading4: `K) Global Saint Gadge Baba also, following the words of Universal Saint Tukaram Maharaj, "Shabdachi Ha Dev" (Words themselves are God), said in his final sermon at Byculla, "God exists in the world; serve the world," O Divine One. `,
            lastDetails5: `L) By empowering oneself, not only can one achieve longevity but also a century-long life. In daily usage, "Shabdakoshavinashabd" (words beyond the dictionary) consists of various types of words—some suitable for expression, while others depend on time, place, and context. The relative impact of words must be assessed according to the situation, determining whether they should be spoken or withheld.
