...
const Home = () => {
    ...
    const content = {
        en: {
            ...
            title2: `"Shabdapathhi of origin of natural words " `,
            ...
            "I am the charity of words, I have all the words!
            ...
            According to Sant Avadhoot Maharaj, when the market of words fades away, just as darkness follows the setting of the sun, moon, and stars, similarly, if the stars of wisdom vanish, true faith itself will be mistaken for blind faith, and blind faith will be mistaken for true faith. In today’s world, many ancient words of our ancestors have either disappeared or been altered. If they are restored to their original form, then through the pronunciation of wordless-words, not only can primary treatments and remedies be provided, but also, despite having these healing words, many human lives are being lost prematurely simply because they are not accessed or used.`,
            lastDetailsheading3: ``,
